...
export const metadata: Metadata = {
  title: 'FAQ - Frequently Asked Questions | Tasheel',
  description: 'Find answers to common questions about Tasheel\'s safety management platform, pricing, features, and support.',
  keywords: 'tasheel faq, safety software questions, contractor platform help',
}
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground">
            Find answers to common questions about Tasheel
          </p>
        </div>
